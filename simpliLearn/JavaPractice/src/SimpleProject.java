...
public class SimpleProject { 	
	...
	String fileName;
	String path = "C:\\\\Users\\users\\\\Downloads\\\\Fullstack\\\\Simplilearn\\";
	...
	{
		System.out.println("Enter 1 to Retriev the file names in an ascending order");
	...
	SimpleProject(boolean b) throws IOException
	{
		...
		SimpleProject proj = new SimpleProject();
		while (b) {
			proj.FileFeatures();
		}
	}
...
public static void main(String[] args) throws IOException {
	...
	//Main Menu Execution
	SimpleProject proj = new SimpleProject(true);
}
}